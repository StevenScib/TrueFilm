...
export const AuthProvider = ({ children }) => {
    ...
    //this handles user logging out by resetting the authentican state and clears the user information from the localstorage and removes authorisation header
    const logout = () => {
    ...
    //sets the JWT token to authorisation header of axios requests 
    useEffect(() => {
